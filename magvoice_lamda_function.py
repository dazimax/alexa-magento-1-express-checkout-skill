...
def lambda_handler(event, context):
    if (event["session"]["application"]["applicationId"] !=
            "amzn1.ask.skill.fbea6747-cf0c-4178-b6ca-*****"):
...
def send_customer_enquery(website, email_subject, email_body):
    ...
    support_email = 'dazimax@gmail.com'
    USER_EMAIL = 'dazimax@hotmail.com'
...
def getWesites(index):
    if index in ["bundabergrum","Bundabergrum", "bundaber grum"]:
        MAGENTO_DOMAIN = 'www.bundabergrum.com.au'
        return "bundabergrum"
